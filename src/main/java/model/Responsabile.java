...
public class Responsabile extends Docente{
    ...
    Responsabile(String nome, String cognome, String email, String login, String password) {
        super(nome, cognome, email, password); //chiama il costruttore di Docente senza variazioni di paramentri, perché Responsabile non ne ha di nuovi rispetto a Docente
    }
}
